...
public class ReportController {
	...
	//------------------------REPORT ALL USERS IN EXCEL FORMAT --------------------------------------------
	...
	public ResponseEntity<Resource> getUserReport(){
		...
		//------------------------REPORT ALL CARS IN EXCEL FORMAT --------------------------------------------
		...
		//------------------------REPORT ALL RESERVATIONS IN EXCEL FORMAT--------------------------------------------
	    
	    //POSTMAN GET  + http://localhost:8080/excel/download/reservations
